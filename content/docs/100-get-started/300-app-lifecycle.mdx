...
<div>
  <Zoom className="img-light">
    <img className="img-light" src="/docs-static/single-presentation-lifecycle-light.excalidraw.png" style={{ maxWidth: 400 }} />
  </Zoom>
  <Zoom overlayBgColorStart="rgba(0, 0, 0, 0)" overlayBgColorEnd="rgba(0, 0, 0, 0.95)">
    <img className="img-dark" src="/docs-static/single-presentation-lifecycle-dark.excalidraw.png" style={{ maxWidth: 400 }} />
  </Zoom>
</div>
...
<div>
  <Zoom>
    <img className="img-light" src="/docs-static/multiple-presentations-lifecycle-light.excalidraw.png" />
  </Zoom>
  <Zoom overlayBgColorStart="rgba(0, 0, 0, 0)" overlayBgColorEnd="rgba(0, 0, 0, 0.95)">
    <img className="img-dark" src="/docs-static/multiple-presentations-lifecycle-dark.excalidraw.png" />
  </Zoom>
</div>
