...
<Callout>
  Generating your own API keys is currently only available for
  [Toast](/docs/on-brand-menu-api/toast). You will be given an API key by our
  team as part of the [Revel](/docs/on-brand-menu-api/revel) setup process.
</Callout>
