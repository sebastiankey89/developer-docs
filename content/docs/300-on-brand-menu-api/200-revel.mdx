...
<Callout>
  The On-Brand Menu API does not currently support groups of sub-items. Revel
  modifier classes attached to a product will be flattened into a single list of
  sub-items.
</Callout>
...
Values in the _Alternative Lookup_ field of a Revel product are converted to menu item tags in the On-Brand Menu API. You can use these tags to set custom data on an item like `featured` or `location:Napa Valley`.
