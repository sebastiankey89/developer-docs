...
<Callout>The On-Brand Menu API does not currently support groups of sub-items. Revel modifier classes attached to a product will be flattened into a single list of sub-items.</Callout>
